...
//$sql="SELECT * FROM stuuuu";//查询全部
//$res=$p1->fetchAll($sql);
//$sql="SELECT * FROM stuuuu WHERE id=915";//查询单条
//$res=$p1->fetchRow($sql);
//$sql="SELECT name FROM stuuuu WHERE id=915";
//$res=$p1->fetchOne($sql);
//$sql="INSERT INTO stuuuu VALUES (null,'杀玲','女','北京',15115115100)";
//$res=$p1->query($sql);
//$sql="UPDATE stuuuu SET sex='男' WHERE id=912";
//$res=$p1->query($sql);
//$sql="DELETE FROM stuuuu WHERE id=901";
//$res=$p1->query($sql);
//echo '<pre>';
//print_r($res);
//echo '</pre>';
